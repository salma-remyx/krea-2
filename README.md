...
## Optional: block-sparse attention (experimental)
...
The retained-mass mechanism was validated in the paper on **video**
diffusion transformers; whether it is a net win for Krea 2's **image**
tokens (and at which resolution/step count) is the open question this flag
exposes for experimentation, not a guaranteed speedup.
